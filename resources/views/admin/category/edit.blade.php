    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ url('admin/update-category/'.$category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label>Image</label>
                    <input type="file" name="image" value="{{ $category->image }}" class="form-control" height="100">
                </div>
                <h6>SEO Tags</h6>
                <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="">
                        <button type="submit" class="btn btn-primary align-self-end" style="margin: 0px auto;">
                            Update Category
                        </button>
                    </div>
