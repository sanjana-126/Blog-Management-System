...
Route::get('/tutorial/{category_slug}/{post_slug}', [App\Http\Controllers\Frontend\FrontendController::class, 'viewPosts']);
...
Route::prefix('admin')->middleware(['auth','isAdmin'])->group(function() {
    ...
    Route::put('reject/{post_id}',[App\Http\Controllers\Admin\PostController::class, 'reject']);
    Route::put('approve/{post_id}',[App\Http\Controllers\Admin\PostController::class, 'approve']);
...
Route::get('/home', [App\Http\Controllers\Author\DashboardController::class, 'index']);
Route::get('/post/{category_slug}/{post_slug}',[\App\Http\Controllers\Author\PostController::class, 'viewposts']);

Route::prefix('author')->group(function() {
    Route::get('create',[\App\Http\Controllers\Author\PostController::class, 'create']);
    Route::post('add-post',[App\Http\Controllers\Author\PostController::class, 'store']);
    Route::get('edit-post/{user_id}',[App\Http\Controllers\Author\PostController::class, 'edit']);
